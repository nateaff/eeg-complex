...
# scatterplot_features("Beta", "Gamma", chdf[[3]], response_type, cex=1)

# ## Channel 5 
# #**Channel 5 Gamma - Beta#**
# scatterplot_features("Beta", "Gamma", chdf[[5]], response_type,cex = 1)
# #**Channel 5 Gamma - Theta#**

# scatterplot_features("Theta", "Gamma", chdf[[5]], response_type, cex = 1)
