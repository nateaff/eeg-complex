...
The $\varepsilon$-complexity of a continuous function is, roughly speaking, the amount of information needed to reconstruct that function within an absolute error $\varepsilon$. The theory and procedure for estimating $\varepsilon$-complexity was introduced by [Darkhovsky and Piryatinska](https://arxiv.org/abs/1303.1777). In previous work, the complexity coefficients [have been shown](https://arxiv.org/abs/1610.01633) to be useful features for the segmentation and classification of time series. 
